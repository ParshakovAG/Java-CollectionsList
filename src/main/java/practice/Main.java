        ...
        while (true) {
            ...
            if (input.equals("HELP")) {
                System.out.println("Принцип работы команд:\n" +
                        ...
                        "ADD — добавляет дело в конец списка или дело на определённое место, сдвигая остальные дела " +
                        "вперёд, если указать номер; если указан несуществующий индекс - добавить в конец списка.\n" +
